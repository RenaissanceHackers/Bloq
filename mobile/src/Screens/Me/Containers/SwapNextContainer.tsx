...
const SwapNextContainer = ({ visible, onClose, setSuccessfully }: PopUpProps) => {
    const handlePress = () => {
        onClose()
        setSuccessfully()
    }
                ...
                <View style={CommonStyles.rectangle53}>
                    <View>
                        ...
                        <View style={styles.frame629478}>
                            <Text style={CommonStyles.textXs_leading4_fontNormal}>From</Text>
...
export default SwapNextContainer
